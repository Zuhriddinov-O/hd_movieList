...
List<FilmDesc> filmDesc = [
  ...
  FilmDesc(
      ...
      type: "Love",
      url: "assets/videos/video_22.mp4",
      description:
          "Maid in Manhattan is a 2002 romantic comedy-drama film starring Jennifer Lopez, Ralph Fiennes, and Natasha Richardson. The plot centers around Marisa Ventura (Jennifer Lopez), a single mother who works as a maid at a luxurious hotel in Manhattan. She struggles to juggle her job and raising her young son Ty (Tyler Posey) while trying to create a better life for them both. One day, while cleaning one of the hotel rooms, Marisa meets Chris Marshall (Ralph Fiennes). Chris is a wealthy and handsome political candidate who is staying at the hotel for a few days. Chris mistakes Marisa for a guest at first, and they begin to spend time together, getting to know each other better. Initially, Marisa is hesitant to reveal her true identity to Chris, but eventually, she opens up and tells him the truth about her life as a maid."),
  FilmDesc(
      id: 23,
