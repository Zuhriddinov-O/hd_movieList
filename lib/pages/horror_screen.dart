...
import 'horror_screen_details.dart';

class HorrorScreen extends StatefulWidget {
  HorrorScreen({super.key, required this.sValue});
...
class _HorrorScreenState extends State<HorrorScreen> {
  ...
  String categories = "Horror Films";
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          itemCount: horrorCategory.length,
          itemBuilder: (context, index) {
            final horrorDescIndex = horrorDetails[index];
            final horrorFilms = horrorCategory[index];
            ...
            return Column(
              ...
              children: [
                    ...
                    child: InkWell(
                        ...
                        Navigator.of(context).push(
                          CupertinoPageRoute(
                            builder: (context) {
                              ...
                              return HorrorScreenDetails(
                                sValue: widget.sValue,
                                horror: horrorDetails[index],
                                horrorCategory: horrorCategory[index],
                      ...
                      child: Ink(
                        child: Stack(
                          children: [
                            Image.network(
                              horrorCategory[horrorFilms.id].images,
                              fit: BoxFit.fill,
                              height: 200,
                            ),
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    horrorCategory[horrorDescIndex.id].ratings.toString(),
                ...
                Text(
                  ...
                  horrorCategory[horrorDescIndex.id].names,
